 ...
 * @dev uses SafeERC20
 */ 
contract StakingTokenUpgradable is Initializable
{
    using SafeERC20 for IERC20;
    IERC20 public token;//removing immutable cause I'm using it in initialze function.
    ...
    uint256 public rebasingIndex; //higher the rebasing index, lesser will be the tokens of user.
    uint256 public moneyToGiveToUser;
    uint256 public totalStakedTokens;
    uint256 public totalTokensReceivedToUser;
